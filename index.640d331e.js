 ...
 * limitations under the License.
 */
const I="firebase-heartbeat-store";let N=null;function T(){return N||(N=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(I)}}).catch((e=>{throw _.create("idb-open",{originalErrorMessage:e.message})}))),N}async function S(e,t){try{const n=(await T()).transaction(I,"readwrite"),i=n.objectStore(I);await i.put(t,R(e)),await n.done}catch(e){if(e instanceof s.FirebaseError)d.warn(e.message);else{const t=_.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});d.warn(t.message)}}}function R(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
